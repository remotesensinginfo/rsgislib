...
namespace rsgis { namespace classifier {
	...
	void RSGISSpectralCorrelationMapperRule::calcImageValue(float *bandValues, int numBands, float *output) throw(RSGISImageCalcException)
	{
	...
	void RSGISSpectralCorrelationMapperClassifier::calcImageValue(float *bandValues, int numBands, float *output) throw(RSGISImageCalcException)
	{										
