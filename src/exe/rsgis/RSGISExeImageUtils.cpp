...
{
	cout << "<rsgis:commands>\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"colourimage\" image=\"image.env\" output=\"image_out.env\">\n";
	cout << "\t\t<rsgis:colour name=\"class_name_1\" id=\"int\" band=\"int\" lower=\"double\" upper=\"double\" red=\"int\" green=\"int\" blue=\"int\" />\n";
	cout << "\t\t<rsgis:colour name=\"class_name_2\" id=\"int\" band=\"int\" lower=\"double\" upper=\"double\" red=\"int\" green=\"int\" blue=\"int\" />\n";
	cout << "\t\t<rsgis:colour name=\"class_name_3\" id=\"int\" band=\"int\" lower=\"double\" upper=\"double\" red=\"int\" green=\"int\" blue=\"int\" />\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"mosaic\" output=\"image_out.env\" nodata=\"float\" proj=\"OSGB | IMAGE\">\n";
	cout << "\t\t<rsgis:image file=\"image1\" />\n";
	cout << "\t\t<rsgis:image file=\"image2\" />\n";
	cout << "\t\t<rsgis:image file=\"image3\" />\n";
	cout << "\t\t<rsgis:image file=\"image4\" />\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"mosaic\" dir=\"directory\" ext=\"file_extension\" output=\"image_out.env\" nodata=\"float\" proj=\"OSGB | IMAGE\"/>\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"include\" image=\"base_image.env\" >\n";
	cout << "\t\t<rsgis:image file=\"image1\" />\n";
	cout << "\t\t<rsgis:image file=\"image2\" />\n";
	cout << "\t\t<rsgis:image file=\"image3\" />\n";
	cout << "\t\t<rsgis:image file=\"image4\" />\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"include\" image=\"base_image.env\" dir=\"directory\" ext=\"file_extension\" />\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"cut2poly\" image=\"image.env\" output=\"image_out_base\" vector=\"vector.shp\" outfilename=\"attribute\" nodata=\"float\" />\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"mask\" image=\"image.env\" mask=\"mask.env\" output=\"image_out.env\" maskvalue=\"float\" />\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"resample\" image=\"image.env\" output=\"image_out.env\" scale=\"float\" interpolation=\"Cubic | BilinearArea | BilinearPoint | NN | Triangular\" />\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"rasterisedefiniens\" inDIR=\"/input/directory/\" outDIR=\"/output/directory\" proj=\"OSGB | IMAGE\"/>\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"printProj4\" image=\"image.env\" />\n";
	cout << "\t<rsgis:command algor=\"imageutils\" option=\"printWKT\" image=\"image.env\" />\n";
	cout << "</rsgis:commands>\n";
}
