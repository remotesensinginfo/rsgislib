...
class RSGISExeEstimationAlgorithm : public RSGISAlgorithmParameters
	...
	{
		none,
		fullPolSingleSpeciesPoly,
		dualPolSingleSpeciesPoly,
		dualPolSingleSpeciesMaskPoly,
		fullPolSingleSpeciesMaskPoly,
		dualPolSingleSpecies,
		dualPolObject,
		fullPolObject,
		dualPolObjectObjAP,
		fullPolObjectObjAP,
		dualPolSingleSpeciesPixAP,
		fullPolSingleSpeciesPixAP,
		dualPolSingleSpeciesMaskPixAP,
		fullPolSingleSpecies,
		fullPolSingleSpeciesMask,
		dualPolSingleSpeciesMask,
		dualPolFPCSingleSpecies,
		fullPolMultiSpecies,
		dualPolMultiSpecies,
		dualPolFPCMoistureSingleSpecies,
