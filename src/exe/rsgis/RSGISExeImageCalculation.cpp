...
{
	cout << "<rsgis:commands>\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"normalise\" image=\"image.env\" output=\"image_out.env\" outmin=\"double\" outmax=\"double\" />\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"normalise\" image=\"image.env\" output=\"image_out.env\" inmin=\"double\" inmax=\"double\" outmin=\"double\" outmax=\"double\" />\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"normalise\" dir=\"directory\" ext=\"file_extension\" output=\"image_out.env\" outmin=\"double\" outmax=\"double\" />\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"normalise\" dir=\"directory\" ext=\"file_extension\" output=\"image_out.env\" inmin=\"double\" inmax=\"double\" outmin=\"double\" outmax=\"double\" />\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"correlation\" imageA=\"imageA.env\" imageB=\"imageB.env\" output=\"matrix.mtxt\" />\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"covariance\" imageA=\"imageA.env\" imageB=\"imageB.env\" output=\"matrix.mtxt\" />\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"covariance\" imageA=\"imageA.env\" imageB=\"imageB.env\" output=\"matrix.mtxt\" meanA=\"matrixA.mtxt\" meanB=\"matrixB.mtxt\"/>\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"meanvector\" image=\"image.env\" output=\"matrix.mtxt\" />\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"pca\" image=\"image.env\" output=\"image_out.env\" eigenvectors=\"matrix.mtxt\" components=\"int\" />\n";
	cout << "\t<rsgis:command algor=\"imagecalc\" option=\"standardise\" image=\"image.env\" output=\"image_out.env\" meanvector=\"matrix.mtxt\" />\n";
	cout << "</rsgis:commands>\n";
}
