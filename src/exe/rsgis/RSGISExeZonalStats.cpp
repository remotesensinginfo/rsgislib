...
{
	cout << "<rsgis:commands>\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"polygons2shp\" image=\"image.env\" vector=\"polys.shp\" output=\"output.shp\" mean=\"yes\" max=\"yes\" min=\"yes\" stddev=\"yes\" />\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"rasterpolygons2shp\" image=\"image.env\" raster=\"polys.env\" vector=\"polys.shp\" output=\"output.shp\" mean=\"yes\" max=\"yes\" min=\"yes\" stddev=\"yes\" />\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"rasterpolygons2txt\" image=\"image.env\" raster=\"polys.env\" vector=\"polys.shp\" output=\"output.txt\" mean=\"yes\" max=\"yes\" min=\"yes\" stddev=\"yes\" />\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"pixelVals2txt\" image=\"image.env\" vector=\"polys.shp\" output=\"output_base\" attribute=\"classname\" outTXT=\"mtxt | gtxt | csv\" />\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"image2matrix\" image=\"image.env\" vector=\"polys.shp\" output=\"output.mtxt\" band=\"int\" />\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"pixelcount\" image=\"image.env\" raster=\"polys.env\" vector=\"polys.shp\" output=\"output.shp\" force=\"yes | no\" pxlcount=\"yes | no\" emptyset=\"yes | no\">\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" threshold=\"float\" />\n";
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" threshold=\"float\" />\n";
	cout << "\t\t\t<rsgis:band band=\"int\" threshold=\"float\" />\n";
	cout << "\t\t\t<rsgis:band band=\"int\" threshold=\"float\" />\n";
	...
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"pixelmean\" image=\"image.env\" raster=\"polys.env\" vector=\"polys.shp\" output=\"output.shp\" force=\"yes | no\" pxlcount=\"yes | no\">\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" threshold=\"float\" />\n";
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" >\n";
	...
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"pixelWeightedMean\" image=\"image.env\" vector=\"polys.shp\" output=\"output.shp\"\n";
	cout << "force=\"yes | no\" pxlcount=\"yes | no\">\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" threshold=\"float\" />\n";
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"pixelmeanLSSVar\" image=\"image.env\" vector=\"polys.shp\" output=\"output.shp\"\n";
	cout << "force=\"yes | no\" pxlcount=\"yes | no\"\n";
	cout << "windowSize=\"int\" offsetSize=\"float\">\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" threshold=\"float\" />\n";
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"fuzzy\" image=\"image.env\" raster=\"polys.env\" vector=\"polys.shp\" classattribute=\"string\" output=\"output.shp\" force=\"yes | no\" binsize=\"int\" threshold=\"float\" pxlcount=\"yes | no\" >\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" class=\"string\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" />\n";
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" class=\"string\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" />\n";
	cout << "\t\t\t<rsgis:band band=\"int\" />\n";
	...
	cout << "\t\t\t<rsgis:band band=\"int\" />\n";
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" threshold=\"float\" class=\"string\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" />\n";
	cout << "\t\t\t<rsgis:band band=\"int\" />\n";
	cout << "\t\t\t<rsgis:band band=\"int\" />\n";
	cout << "\t\t\t<rsgis:band band=\"int\" />\n";
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t<rsgis:command algor=\"zonalstats\" option=\"powersetcount\" image=\"image.env\" raster=\"polys.env\" vector=\"polys.shp\" output=\"output.shp\" force=\"yes | no\" nTop=\"int\">\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" >\n";
	cout << "\t\t\t<rsgis:band band=\"int\" threshold=\"float\" />\n";
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t\t<rsgis:attribute name=\"attribute_name\" >\n";
	...
	cout << "\t\t</rsgis:attribute>\n";
	cout << "\t</rsgis:command>\n";
	cout << "\t	<rsgis:command algor=\"zonalstats\" option=\"pointvalue\" image=\"image.env\" vector=\"points.shp\" output=\"output.shp\" force=\"yes | no\" />\n";
	cout << "</rsgis:commands>\n";
}
