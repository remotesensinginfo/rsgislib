...
namespace rsgis{ namespace cmds {
    ...
    void executePopulateGeomZField(std::string inputVectorFile, std::string inputVectorLyr, std::string inputImage, unsigned int imgBand, std::string outputVectorFile, std::string outputVectorLyr, std::string outFormat, bool delExistVec)
    {
        /*
    ...
    void executeCheckValidateGeometriesexecuteCheckValidateGeometries(std::string inputVectorFile, std::string inputVectorLyr, std::string outputVectorFile, std::string outputVectorLyr, std::string outFormat, bool printGeomErrs, bool delExistVec)
    {
        /*
        try
        {
