...
namespace rsgis{ namespace cmds {
    ...
    void executeLandsatTMCloudFMask(std::string inputTOAImage, std::string inputThermalImage, std::string inputSaturateImage, std::string validImg, std::string outputImage, std::string gdalFormat, double sunAz, double sunZen, double senAz, double senZen, float whitenessThreshold, float scaleFactorIn, std::string tmpImgsBase, std::string tmpImgFileExt, bool rmTmpImgs) throw(RSGISCmdException)
    {
        ...
        try
        {
            ...
            //GDALDataset *pass1DS = imgUtils.createCopy(reflDataset, 16, pass1TmpOutImage, gdalFormat, GDT_Float32);
            ...
            if(propPCP < 0.95)
            {
                ...
                GDALDataset *nirBandDS = imgUtils.createCopy(pass1DS, 1, tmpNIRBandImg, gdalFormat, imgReflDT);
                ...
                GDALDataset *nirBandFillDS = imgUtils.createCopy(pass1DS, 1, tmpNIRFillBandImg, gdalFormat, imgReflDT);
                ...
                GDALDataset *swirBandDS = imgUtils.createCopy(pass1DS, 1, tmpSWIRBandImg, gdalFormat, imgReflDT);
                ...
                GDALDataset *swirBandFillDS = imgUtils.createCopy(pass1DS, 1, tmpSWIRFillBandImg, gdalFormat, imgReflDT);
                ...
                GDALDataset *potentCloudShadowDS = imgUtils.createCopy(pass1DS, 1, tmpPotentShadows, gdalFormat, GDT_Int32);
