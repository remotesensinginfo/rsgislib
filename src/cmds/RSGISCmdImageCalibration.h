...
namespace rsgis{ namespace cmds {
    ...
    DllExport void executeLandsatTMCloudFMask(std::string inputTOAImage, std::string inputThermalImage, std::string inputSaturateImage, std::string validImg, std::string outputImage, std::string pass1TmpOutImage, std::string landWaterTmpOutImage, std::string cloudLandProbTmpOutImage, std::string tmpNIRBandImg, std::string tmpNIRFillBandImg, std::string tmpPotentClouds, std::string gdalFormat, float scaleFactorIn) throw(RSGISCmdException);
