...
#ifndef RSGISIntValuePolygonReader_H
#define RSGISIntValuePolygonReader_H
...
namespace rsgis{namespace vec{
	...
	{
	public:
		RSGISIntValuePolygonReader(string valueattribute, list<RSGIS2DPoint*> *data);
		...
		virtual ~RSGISIntValuePolygonReader();
	protected:
