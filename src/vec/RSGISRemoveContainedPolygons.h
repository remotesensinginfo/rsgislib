...
namespace rsgis{namespace vec{
	...
	public:
		...
		long unsigned removeContainedPolygons(OGRLayer *input, OGRLayer *output);
		long unsigned removeContainedPolygons(OGRLayer *input, OGRLayer *output, std::vector<OGRPolygon*> *inputPolys);
