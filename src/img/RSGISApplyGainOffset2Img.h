...
#ifndef RSGISApplyGainOffset2Img_H
#define RSGISApplyGainOffset2Img_H
...
namespace rsgis{namespace img{
    ...
    class DllExport RSGISRescaleImageData : public RSGISCalcImageValue
    {
    public:
        RSGISRescaleImageData(int numOutputBands, float cNoDataVal, float cOffset, float cGain, float nNoDataVal, float nOffset, float nGain);
