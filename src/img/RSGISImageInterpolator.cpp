...
namespace rsgis{namespace img{
	...
	double RSGISCubicInterpolator::interpolate(double xShift, double yShift, double *pixels) throw(RSGISImageException)
	{
		double pixelValue = 0;
	...
	double RSGISBilinearAreaInterpolator::interpolate(double xShift, double yShift, double *pixels) throw(RSGISImageException)
	{
	...
	double RSGISBilinearPointInterpolator::interpolate(double xShift, double yShift, double *pixels) throw(RSGISImageException)
	{
		double pixelValue = 0;
		double x1Linear = 0;
		double x2Linear = 0;
	...
	double RSGISNearestNeighbourInterpolator::interpolate(double xShift, double yShift, double *pixels) throw(RSGISImageException)
	{		
		/************ Calculate New Pixel Value ************/
		double pixelValue = 0;
		int pixelIndex = 0;
	...
	double RSGISTriangulationInterpolator::interpolate(double xShift, double yShift, double *pixels) throw(RSGISImageException)
	{
