...
namespace rsgis{namespace img{
	...
	void RSGISApplySingleVarFunction::calcImageValue(float *bandValues, int numBands, float *output) throw(RSGISImageCalcException)
	{
	...
	void RSGISApplyTwoVarFunction::calcImageValue(float *bandValues, int numBands, float *output) throw(RSGISImageCalcException)
	{
	...
	void RSGISApplyThreeVarFunction::calcImageValue(float *bandValues, int numBands, float *output) throw(RSGISImageCalcException)
	{
