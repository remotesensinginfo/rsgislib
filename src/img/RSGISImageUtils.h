	...
	namespace img
	{
		...
		class DllExport RSGISImageUtils
			...
			public:
                ...
                GDALDataset* createCopy(GDALDataset *inData, unsigned int numBands, std::string outputFilePath, std::string outputFormat, GDALDataType eType, double xMin, double xMax, double yMin, double yMax, double xRes, double yRes, bool useImgProj=true, std::string proj="")throw(RSGISImageException);
