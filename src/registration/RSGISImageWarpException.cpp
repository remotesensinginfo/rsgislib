...
#include "RSGISImageWarpException.h"
...
namespace rsgis{namespace reg{
	...
	RSGISImageWarpException::RSGISImageWarpException(const char* message) : RSGISRegistrationException(message)
	{
