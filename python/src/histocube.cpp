...
"Where:\n"
"\n"
":param filename: is the file path and name for the histogram cube file.\n"
":param numOfFeats: is the number of features within the cube - this is defined globally within the file.\n"
"\n"
"Example::\n"
"\n"
...
"\n"
":param filename: is the file path and name for the histogram cube file.\n"
":param layerName: is the name of the layer to be created.\n"
":param lowBin: is the lower limit of the histogram bins created (Can be negative).\n"
":param upBin: is the upper limit of the histogram bins created.\n"
":param scale: is the scale parameter used to scale/offset the input data (Optional: default = 1)\n"
":param offset: is the offset parameter used to scale/offset the input data (Optional: default = 0) \n"
":param hasDateTime: is a boolean parameter specifying whether the layer has a date/time associated with it (Optional: default = False).\n"
":param dataTime: is an ISO string representing the date and time associated with the layer.\n"
"\n"
"Example::\n"
"\n"
"    import rsgislib.histocube\n"
...
":param filename: is the file path and name for the histogram cube file.\n"
":param layerName: is the name of the layer to be created.\n"
":param clumpsImg: is a clumps image that specifies which histogram cube row pixels in with values image are associated (note resolution must be the same as the values image).\n"
":param valsImg: is the image with the values which are populated into the histogram cube.\n"
":param band: is the band number (note band numbers start at 1)\n"
":param inMem: is a boolean specifying whether the data array should be kept in memory; much faster in memory. (Optional, default is True)\n"
"\n"
"Example::\n"
"\n"
"    import rsgislib.histocube\n"
...
":param layerName: is the name of the layer to be created.\n"
":param clumpsImg: is a clumps image that specifies which histogram cube row pixels in with values image are associated (note resolution must be the same as the values image).\n"
":param outputImg: is the file path to the output image.\n"
":param gdalformat: is the format of the output image (e.g., KEA)\n"
":param binidxs: is list of indexed (start 0) within the histogram to export.\n"
"\n"
"Example::\n"
"\n"
"    import rsgislib.histocube\n"
...
":param filename: is the file path and name for the histogram cube file.\n"
"\n"
":return: List of layer names of string type.\n"
"\n"
"Example::\n"
"\n"
"    import rsgislib.histocube\n"
...
":param outputImg: is the file path to the output image.\n"
":param gdalformat: is the format of the output image (e.g., KEA)\n"
":param datatype: specifies one of the values from rsgislib.TYPE_*\n"
":param binstats: is list of summary statistics which will be calculated for each histogram and exported (Must be of type: rsgislib.histocube.SUMTYPE_HC_*).\n"
"\n"
"Example::\n"
"\n"
"    import rsgislib\n"
