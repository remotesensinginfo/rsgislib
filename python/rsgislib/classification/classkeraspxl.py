...
def train_keras_pixel_classifer(cls_mdl, cls_info_dict, out_mdl_file=None,
...
def apply_keras_pixel_classifier(class_train_info, keras_cls_mdl, in_img_mask,
                                 img_mask_val, img_file_info, out_class_img,
                                 gdalformat, pred_batch_size=32, class_clr_names=True):
    """
