...
def calc_acc_metrics_vecsamples(in_vec_file, in_vec_lyr, ref_col, cls_col, cls_img, img_cls_name_col='ClassName',
    ...
    ref_vals = numpy.array(rsgislib.vectorattrs.read_vec_column(in_vec_file, in_vec_lyr, ref_col))
    cls_vals = numpy.array(rsgislib.vectorattrs.read_vec_column(in_vec_file, in_vec_lyr, cls_col))
    ...
    if out_csv_file is not None:
        ...
        with open(out_csv_file, mode='w') as out_csv_file_obj:
            ...
            for cls_name, cm_row, user_acc in zip(unq_cls_names, acc_metrics['confusion_matrix'],
